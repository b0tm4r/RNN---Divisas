...
data_train = dataset_train.iloc[:-periodos_a_predecir, 1:2]
...
plt.legend()
plt.savefig(os.path.join(dir_path,'result','{}-prediccion-{}-periodos-test.jpg'.format(valor,periodos_a_predecir)))
plt.show()
